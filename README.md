...
원본은 NYC TLC가 제공하는
[2026년 5월 Yellow Taxi Trip Records Parquet](https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2026-05.parquet)입니다.
...
| 5분 발표 대본                | [`presentation_notes.md`](reports/final/presentation_notes.md)                                                               | 완료 |

`total_amount`는 연속형 회귀 타깃이므로 정확도·F1 대신 MAE, RMSE, Median AE,
R²를 사용합니다. 평균 금액만 예측하는 Dummy 기준선도 함께 계산해 최종 모델의
개선폭을 확인합니다.
